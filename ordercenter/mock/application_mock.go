...
// Source: internal/application/applicationservice.go

// Package mock is a generated GoMock package.
package mock

import (
	command "ordercenter/internal/application/command"
	response "ordercenter/internal/application/response"
	domain "ordercenter/internal/domain"
	errors "ordercenter/internal/pkg/errors"
	reflect "reflect"
...
func (m *MockIApplicationService) PlaceOrderHandler(placeOrderCommand command.PlaceOrderCommand) (response.PlaceOrderResponse, *errors.ErrorWithCode) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PlaceOrderHandler", placeOrderCommand)
	ret0, _ := ret[0].(response.PlaceOrderResponse)
	ret1, _ := ret[1].(*errors.ErrorWithCode)
	return ret0, ret1
}
